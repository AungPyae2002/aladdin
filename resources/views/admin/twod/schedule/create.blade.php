        ...
        <div class="container-fluid">
            <div class="col-md-6 mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.twod_schedule.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="twod_type">Type</label>
                                <select class="form-control" name="twod_type" id="twod_type">
                                    @foreach ($types as $type)
                                        <option 
                                        @if (old('twod_type')  == $type->id)
                                            selected
                                        @endif
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="mr-1" style="flex-grow: 1">
                                <input required id="opening_time" name="opening_time" type="time" class="form-control @error('opening_time') is-invalid @enderror" value="{{old('opening_time')}}">
                                @error('opening_time')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="mr-1 input-group" style="flex-grow: 1">
                                    <input required id="multiply" name="multiply" type="number" class="form-control @error('multiply') is-invalid @enderror" placeholder="Enter commision percent" value="{{old('multiply')}}">
