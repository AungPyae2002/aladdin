    ...
    <div class="content pt-3">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.twod_section.update',$section->id)}}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="mr-1" style="flex-grow: 1">
                                    <input readonly id="type" name="type" type="text" class="form-control @error('type') is-invalid @enderror" value="{{$section->type->name ?? null}}">
                                    @error('type')
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="mr-1" style="flex-grow: 1">
                                    <input id="set" name="set" type="number" class="form-control @error('set') is-invalid @enderror" step=".01" placeholder="Enter set" value="{{old('set') ??  $section->set}}">
                                    @error('set')
                                        <span class="error invalid-feedback">
                                            {{$message}}
                                        </span>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="mr-1" style="flex-grow: 1">
                                    <input id="value" name="value" type="number" class="form-control @error('value') is-invalid @enderror" step=".01" placeholder="Enter value" value="{{old('value') ??  $section->value}}">
                                    @error('value')
                                        <span class="error invalid-feedback">
                                            {{$message}}
                                        </span>
            ...
            <div class="card">
                <form action="{{route("admin.twod_section.number.update",$section->id)}}" method="POST">
                    @csrf
                    <div class="card-header">
