            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                <div class="card-header">
                  <h1 class="card-title">Register Agent</h1>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                         ...
                         <div class="col-12">
                            <div class="form-group">
                                <label for="commision_percent">Commision</label>
                                <div class="mr-1 input-group" style="flex-grow: 1">
                                    <input required id="commision_percent" name="commision_percent" type="number" class="form-control @error('commision_percent') is-invalid @enderror" placeholder="Enter commision percent" value="{{old('commision_percent')}}">
